...
/*
 * Squelette : plugins/auto/ahuntsic/inc/inc-art-documents.html
...
/* BOUCLE documents  */
 ...
 function BOUCLE_documents_portfoliohtml_23012de0ed4ec96ceffde8ff880a12d3(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/auto/ahuntsic/inc/inc-art-documents.html','html_23012de0ed4ec96ceffde8ff880a12d3','_documents_portfolio',2,$GLOBALS['spip_lang']));
	if ($result) {
	$SP++;
	// RESULTATS
...
/* BOUCLE documents  */
 ...
 function BOUCLE_afficher_documenthtml_23012de0ed4ec96ceffde8ff880a12d3(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/auto/ahuntsic/inc/inc-art-documents.html','html_23012de0ed4ec96ceffde8ff880a12d3','_afficher_document',18,$GLOBALS['spip_lang']));
	if ($result) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP] = @sql_fetch($result)) {
...
(($t1 = strval(filtrer('image_graver',filtrer('image_reduire',
	...
	recuperer_fond('modeles/emb', array('lang' => $GLOBALS["spip_lang"] ,'id_document'=>$Pile[$SP]['id_document'],'id'=>$Pile[$SP]['id_document'],'recurs'=>(++$recurs)), array('compil'=>array('plugins/auto/ahuntsic/inc/inc-art-documents.html','html_23012de0ed4ec96ceffde8ff880a12d3','_afficher_document',0,$GLOBALS['spip_lang']), 'trim'=>true), ''))
,'520','0'))))!=='' ?
		((	'<a href="' .
...
/* BOUCLE documents  */
 ...
 function BOUCLE_documents_decomptehtml_23012de0ed4ec96ceffde8ff880a12d3(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/auto/ahuntsic/inc/inc-art-documents.html','html_23012de0ed4ec96ceffde8ff880a12d3','_documents_decompte',30,$GLOBALS['spip_lang']));
	if ($result) {
...
'
' .
(($Numrows['_documents_decompte']['total'] == '1') ? trim(recuperer_fond( 'modeles/emb' , array('id_document' => $Pile[$SP]['id_document'] ), array('compil'=>array('plugins/auto/ahuntsic/inc/inc-art-documents.html','html_23012de0ed4ec96ceffde8ff880a12d3','_documents_decompte',32,$GLOBALS['spip_lang'])), '')):''));
	}
	@sql_free($result);
	}
	return $t0;
...
/* BOUCLE documents  */
 ...
 function BOUCLE_documents_jointshtml_23012de0ed4ec96ceffde8ff880a12d3(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	// REQUETE
	$result = calculer_select($select, $from, $type, $where, $join, $groupby, $orderby, $limit, $having, $table, $id, $connect,
		 array('plugins/auto/ahuntsic/inc/inc-art-documents.html','html_23012de0ed4ec96ceffde8ff880a12d3','_documents_joints',39,$GLOBALS['spip_lang']));
	if ($result) {
...
//
// Fonction principale du squelette plugins/auto/ahuntsic/inc/inc-art-documents.html
// Temps de compilation total: 48.759 ms
//

function html_23012de0ed4ec96ceffde8ff880a12d3($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'
' .
(($t1 = BOUCLE_documents_portfoliohtml_23012de0ed4ec96ceffde8ff880a12d3($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
'
	...
	' .
BOUCLE_afficher_documenthtml_23012de0ed4ec96ceffde8ff880a12d3($Cache, $Pile, $doublons, $Numrows, $SP) .
'


' .
BOUCLE_documents_decomptehtml_23012de0ed4ec96ceffde8ff880a12d3($Cache, $Pile, $doublons, $Numrows, $SP) .
'



	' .
(($t1 = BOUCLE_documents_jointshtml_23012de0ed4ec96ceffde8ff880a12d3($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
');
	...
	return analyse_resultat_skel('html_23012de0ed4ec96ceffde8ff880a12d3', $Cache, $page, 'plugins/auto/ahuntsic/inc/inc-art-documents.html');
}
?>