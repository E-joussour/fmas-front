...
'alerte_maj_impossible' => '<b>Al&egrave;rta!</b> Es impossible d\'actualizar la basa SQL v&egrave;rs la version @version@; benl&egrave;u i a un probl&egrave;ma relatiu au drech de modificar la basa de donadas. Vorgatz contactar lo v&ograve;stre aubergador.',
...
'form_pet_envoi_mail_confirmation' => 'A&uuml;ra recebretz un e-mail de confirmacion. Per validar la v&ograve;stra signatura, cau vesitar l\'adrei&ccedil;a web men&ccedil;onada per aquest corrier.', # MODIF
...
'forum_attention_dix_caracteres' => '<b>Atencion!</b> lo v&ograve;stre messatge deu tenir aumens d&egrave;tz caract&egrave;rs.',
'forum_attention_trois_caracteres' => '<b>Atencion!</b> lo v&ograve;stre t&iacute;tol deu tenir aumens tres caract&egrave;rs.',
...
'info_creer_repertoire_2' => 'dintre lo sosrepert&ograve;ri   <b>@repertoire@</b>, pi:',
...
'info_erreur_systeme2' => 'Lo disc dur es benl&egrave;u plen, &ograve; la basa de donadas degalhada. <br />
 <font color=\'red\'>Assaiatz de <a href=\'@script@\'>reparar la basa</a>,
 &ograve; contactatz lo v&ograve;stre aubergador.</font>',
'info_fini' => 'Es acabat!',
...
'info_installer_documents' => 'Pod&egrave;tz installar automaticament toi lu documents contenguts dins lo repert&ograve;ri @upload@.',
'info_installer_ftp' => 'Coma administrator, pod&egrave;tz installar (per FTP) de fichiers dins lo dorsier @upload@, pi lu seleccionar directament aic&iacute;.',
'info_installer_images' => 'Pod&egrave;tz installar d\'imatges ai formats JPEG, GIF e PNG.',
'info_installer_images_dossier' => 'Installar d\'imatges dins lo dorsier @upload@ per lu poder seleccionar aic&iacute;.',
...
'info_trop_resultat' => 'Tr&ograve;up de resultats per "@cherche_mot@"; vorgatz afinar la c&egrave;rca.',
...
'info_zoom' => 'zoom',
'infos_vos_pense_bete' => 'Lu v&ograve;stres mementos', # MODIF
...
'titre_probleme_technique' => 'Atencion: un probl&egrave;ma tecnic (servidor SQL) empedisse d\'accedir a aquela part dau sit. Merc&eacute; de la v&ograve;stra indulg&eacute;ncia.',
...
'zbug_erreur_execution_page' => 'error d\'execucion de la p&agrave;gina', # MODIF
