...
'alerte_maj_impossible' => '<b>Attenzione!</b> L\'aggiornamento del database SQL alla versione @version@ &egrave; impossibile, forse a causa di un problema con i diritti di modifica nel database. Contattare il proprio fornitore di hosting.',
...
'form_auteur_email_modifie' => 'Il tuo indirizzo email &egrave; stato modificato',
'form_auteur_envoi_mail_confirmation' => 'Una email di conferma &egrave; stata inviata a  @email@. &Egrave; necessario visitare l\'URL indicata nel messaggio per convalidare il tuo indirizzo email.',
...
indirizzo qui sotto. (Altrimenti la tua richiesta sar&agrave; ignorata.):
