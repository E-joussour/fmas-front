...
'avis_connexion_echec_1' => 'Koneksyon sou s&eacute;v&egrave; SQL te pa mache.', # MODIF
...
'avis_connexion_echec_3' => '<b>Atansyon</b> Ak enp&egrave; s&eacute;v&egrave; sa-yo f&ograve;k  w <b>domann</b> ou l&eacute;b&egrave;rg&egrave; te aktive laks&eacute; labaz SQL, avan w kap itilize ali. Si w vwa se pa posib m&egrave;m konek a w, ann gad byen si w te domann ali avan.', # MODIF
...
'avis_site_syndique_probleme' => 'Atansyon : sendikasyon pou sit sa-a gen yon pwobl&egrave;m&nbsp;; sist&egrave;m pa mache kounyen-a. Gad si ladr&egrave;s fichye sendikasyon sit-la se kor&egrave;k (<b>@url_syndic@</b>), apr&egrave;sa ann esey yon l&ograve;t rekip&eacute;rasyon enf&ograve;masyon sa-yo. ', # MODIF
...
'avis_version_mysql' => 'Ou versyon SQL (@version_mysql@) i gen pa p&eacute;mi ranje tous&egrave;l tab yo andan la bazdon&eacute;.', # MODIF
...
'bouton_radio_sauvegarde_compressee' => 'yon s&ograve;vgad konprese sou @fichier@',
'bouton_radio_sauvegarde_non_compressee' => 'yon s&ograve;vgad sak se pa konprese sou @fichier@',
...
'entree_adresse_fichier_syndication' => 'Ladr&egrave;s fichye pou la sendikasyon&nbsp;:',
...
'entree_liens_sites' => '<b>Lyen ip&egrave;t&egrave;ks</b> (referans, sit pou f&egrave; yon vire...)',
...
'erreur_plugin_tag_plugin_absent' => '&lt;Pa oken plegin an &gt; nan fichye pou d&eacute;finisyon',
...
'info_chemin_acces_annuaire' => 'Opsyon sa-yo : <b>Chemen pou laks&egrave; nan lany&egrave;',
...
'info_creation_tables' => 'Katry&egrave;m etap : <b>Kreye k&egrave;k tab nan bazdone</b>', # MODIF
...
'info_derniere_etape' => 'D&egrave;nye etap : <b> se fin fini !', # MODIF
...
'info_informations_personnelles' => 'Sinky&egrave;m etap : <b>Enf&ograve;masyon p&egrave;sonel yo</b>', # MODIF
...
'info_mise_a_niveau_base' => 'M&egrave;t baz SQL nan bon nivo', # MODIF
...
ak yon lim&egrave;l. W vle itilize opsyon nan&nbsp;?', # MODIF
...
'info_par_nom' => 'krit&egrave; se kouman rele',
...
'info_sauvegarde_reussi_02' => 'Baz-la te fin sovgad&eacute; nan @archive@. W kapab',
...
'info_statut_auteur' => 'Lestati lot&egrave;-a :', # MODIF
...
'taille_cache_infinie' => 'Genyen pa oken limit pou latay r&eacute;pertwar CACHE.',
'taille_cache_maxi' => 'SPIP ka eseye limite latay r&eacute;pertwar CACHE sit-la, alantou <b>@octets@</b> pou tout don&eacute; .',
...
'text_article_propose_publication' => 'Atik ki pwopoze pou f&eacute; par&egrave;t. Ezit pas bay lavi aou nan fowom ki jwen atik-la (anba lapaj).', # MODIF
...
'texte_admin_tech_02' => 'Atansyon: s&ograve;vgad-la ke kapab restore SELMAN sou yon sit ki enstal&eacute; sou yon m&egrave;m v&egrave;syon SPIP. F&ograve;k pa w &laquo;&nbsp;vid labaz&nbsp;&raquo; po enstal&eacute; s&ograve;vgad-la apr&eacute; met nan nivo... Gade <a href="@spipnet@">dokimantasyon SPIP</a>.', # MODIF
...
'texte_choix_base_2' => 'S&egrave;v&egrave; SQL-la, li ka kembe k&egrave;k bazdon&eacute;.', # MODIF
...
'texte_connexion_mysql' => 'Gade tout lenf&ograve;masyon l&eacute;b&egrave;j&egrave; te bay aw&nbsp;: f&ograve;k w rankont tout kod pou koneksyon sou s&egrave;v&egrave; SQL la, si l&eacute;b&eacute;j&egrave; kabab bay yon baz SQL.', # MODIF
...
'texte_en_cours_validation' => 'Atik ak tinouv&egrave;l isit anba, zot se pwopoze pou f&egrave; par&egrave;t. Ezit pa bay lavi aw nan fowom jwen.', # MODIF
...
'texte_jeu_caractere' => 'Lopsyon-an se itil si sitweb-la afiche k&egrave;k alfabe diferan lalfab&eacute;
 ...
 ann f&eacute; osi bo reglaj nan leskel&egrave;t sit w (baliz <tt>#CHARSET</tt>).', # MODIF
...
'texte_mots_cles_dans_forum' => 'Aksepte w tout vizit&eacute; kapab itilize tout mokle nan fowom yo sou sit piblik&nbsp;? (Atansyon&nbsp;: lopsyon-an se konpl&egrave;ks pou itilize.)', # MODIF
...
'texte_referencement_automatique' => '<b>R&eacute;f&eacute;ransman otomatik pou yon sitweb</b><br />W kapab referanse fasilman yon sitweb si w bay ladr&egrave;s URL osnon bay ladr&egrave;s fichye backend ali. SPIP ke pran otomatikman tout enf&ograve;masyon posib pou sit-la (kouman li rele, dekrisyon...).', # MODIF
...
'texte_restaurer_sauvegarde' => 'Opsyon-nan ki p&eacute;m&egrave; w restore yon sovgad  ki w t&eacute; f&eacute; avan sou baz-la.
 ...
 @dossier@.
  ...
  d&eacute;finitif.</b>', # MODIF
'texte_sauvegarde' => 'Sovgad kontni baz-la',
'texte_sauvegarde_base' => 'Sovgad baz-la',
'texte_sauvegarde_compressee' => 'Sovgad ke pou f&egrave; nan yon fichye pa kopr&eacute;s&eacute; sa-a, ki rele @fichier@.', # MODIF
...
'texte_titre_obligatoire' => '<b>Tit (Kouman i rele)</b> [N&egrave;s&egrave;s&egrave;]', # MODIF
...
'titre_cadre_signature_obligatoire' => '<b>Siyati</b> [N&eacute;ses&egrave;]<br />', # MODIF
