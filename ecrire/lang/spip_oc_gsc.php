...
'dirs_probleme_droits' => 'Probl&egrave;ma de drets d\'acc&egrave;s', # MODIF
'dirs_repertoires_absents' => '<b>Non s\'ei pas trobat los repert&ograve;ris seguents: <ul>@bad_dirs@.</ul> </b>
  ...
  <p>Un c&ograve;p qu\'auratz h&egrave;it aqu&ograve;, que poiratz ', # MODIF
'dirs_repertoires_suivants' => '<b>Los repert&ograve;ris seguents non son pas accessibles en escritura: <ul>@bad_dirs@.</ul> </b>
  ...
  <p>Tanl&egrave;u qu\'auratz h&egrave;ita aquera manipulacion, que poiratz ', # MODIF
...
'form_pet_envoi_mail_confirmation' => 'Ara que receberatz un e-mail de confirmacion. T&agrave; validar la v&ograve;sta signatura, que cau vesitar l\'adrei&ccedil;a web men&ccedil;onada per aqueste corri&egrave;r.', # MODIF
...
'forum_poste_par' => 'Messatge poste@parauteur@ qui h&egrave; seguida au v&ograve;ste article.', # MODIF
...
'info_erreur_systeme2' => 'Lo disc dur qu\'ei dilh&egrave;u plen, o la basa de dadas gastada. <br />
 ...
 o contactatz lo v&ograve;ste aubergader.</font>', # MODIF
...
'info_impossible_lire_page' => '<b>Error!</b> Impossible de legir la pagina <tt><html>@test_proxy@</html></tt> a trav&egrave;rs deu proxy <tt>', # MODIF
...
'info_installer_documents' => 'Que podetz installar automaticament tots los documents contenguts dens lo repert&ograve;ri @upload@.', # MODIF
'info_installer_ftp' => 'Com administrator, que podetz installar (per FTP) fichi&egrave;rs dens lo dorsi&egrave;r @upload@, puish seleccion&agrave;\'us dir&egrave;ctament ac&iacute;.', # MODIF
'info_installer_images' => 'Que podetz installar imatges aus formats JPEG, GIF e PNG.',
'info_installer_images_dossier' => 'Installar imatges dens lo dorsi&egrave;r @upload@ ent&agrave;\'us poder seleccionar ac&iacute;.', # MODIF
...
'info_selectionner_fichier' => 'Que podetz seleccionar un fichi&egrave;r deu dorsi&egrave;r @upload@', # MODIF
...
'info_symbole_bleu' => 'Lo simb&egrave;u <b>blau</b> que marca un <b>memento</b>: qu\'ei a d&iacute;ser un messatge tau v&ograve;ste usatge personau.', # MODIF
'info_symbole_jaune' => 'Lo simb&egrave;u <b>jaune</b> que marca un <b>anonci t&agrave; tots los redactors </b>: los administrators que\'u p&ograve;den modificar, cada redactor que\'u p&ograve;t v&eacute;der.', # MODIF
'info_symbole_vert' => 'Lo simb&egrave;u <b>verd</b> que marca los <b>messatges escambiats dab autes utilizaires</b> deu sit.', # MODIF
...
'texte_erreur_mise_niveau_base' => 'Error de basa de dadas pendent la hicada a niv&egrave;u. L\'imatge <b>@fichier@</b> n\'ei pas passat (article @id_article@).
 ...
 enq&uuml;&egrave;ra dens los articles.', # MODIF
'texte_erreur_visiteur' => 'Vous avez tent&eacute; de d\'acc&eacute;der &agrave; l\'espace priv&eacute; avec un login qui ne le permet pas.', # NEW
...
'texte_inc_config' => 'Las modificacions h&egrave;itas dens aquestas paginas qu\'influ&eacute;ncian de b&egrave;th pro lo
 ...
 de deishar la carga d\'aquestas paginas au webm&egrave;stre principau deu v&ograve;ste sit.</b>', # MODIF
'texte_inc_meta_1' => 'Lo sist&egrave;ma qu\'a rescontrat ua error dens l\'escritura deu fichi&egrave;r <code>@fichier@</code>.Volhatz, com administrator/tritz deu sit,', # MODIF
'texte_inc_meta_2' => 'verificar los drets d\'escritura',
'texte_inc_meta_3' => 'dens lo repert&ograve;ri <code>@repertoire@</code>.', # MODIF
...
'zbug_champ_hors_motif' => 'Camp @champ@ en deh&ograve;ra d\'ua bloca de motiu @motif@', # MODIF
