...
'avis_connexion_echec_3' => '<b>N.B.</b> Sus tot plen de servidors, dev&egrave;tz <b>demandar</b> qu\'activen lo v&ograve;stre acc&egrave;s a la basa SQL avans de la poder utilizar. Se non vos pod&egrave;tz connectar, verificatz qu\'augatz ben realizat aqueu procediment.', # MODIF
...
'avis_site_syndique_probleme' => 'Atencion: la sindicacion d\'aqueu sit a rescontrat un probl&egrave;ma; lo sist&egrave;ma es doncas interromput tempor&agrave;riament. Verificatz l\'adrei&ccedil;a dau fichier de sindicacion d\'aqueu sit (<b>@url_syndic@</b>), e tornatz assaiar de recuperar li informacions.', # MODIF
...
'avis_version_mysql' => 'La v&ograve;stra version de SQL (@version_mysql@) non permete l\'autoreparacion dei taulas de la basa.',
...
'entree_adresse_fichier_syndication' => 'Adrei&ccedil;a dau fichier "backend" per la sindicacion:', # MODIF
...
'ical_titre_rss' => 'Fichiers &laquo;backend&raquo;', # MODIF
...
'info_mise_a_niveau_base' => 'Mesa a niv&egrave;u de la v&ograve;stra basa SQL',
...
'info_pense_bete_ancien' => 'Lu v&ograve;stres mementos ancians', # MODIF
...
'text_article_propose_publication' => 'Article prepauat per la publicacion. Non esitetz de donar lo v&ograve;stre vejaire gaug au forum estacat a aquel article (en bas de p&agrave;gina).', # MODIF
...
'texte_admin_tech_01' => 'Aquela opcion vos permete de sauvagardar lo contengut de la basa dins un fichier que ser&agrave; servat dins lo repert&ograve;ri @dossier@.
...
'texte_admin_tech_02' => 'Atencion: aquela sauvagarda si porr&agrave; restaurar BASTA dins un sit installat emb la meteissa version d\'SPIP. Doncas sobretot non cau "vuar la basa" en esperant de re&iuml;nstallar la sauvagarda apr&egrave;s una actualizacion. Consultatz <a href="@spipnet@">la documentacion d\'SPIP</a>.', # MODIF
...
'texte_connexion_mysql' => 'Consultatz li informacions que lo v&ograve;stre aubergador fornisse: i dev&egrave;tz trobar, se lo v&ograve;stre aubergador sup&ograve;rta SQL, lu c&ograve;des de connexion au servidor SQL.', # MODIF
...
'texte_en_cours_validation' => 'Si prepaua de publicar lu articles e br&egrave;vas &ccedil;ai sota. Non esitetz de donar lo v&ograve;stre vejaire gaug ai forums que i son estacats.', # MODIF
...
'texte_jeu_caractere' => 'Aquesta opcion es utila se lo v&ograve;stre sit deu afichar d\'alfabets
 ...
 lo sit public en consequ&eacute;ncia (balisa <tt>#CHARSET</tt>).', # MODIF
...
'texte_sauvegarde_compressee' => 'La sauvagarda si far&agrave; dins lo fichier non comprimit @fichier@.',
...
'utf8_convert_backup' => 'N\'oubliez pas de faire auparavant une sauvegarde compl&egrave;te de votre site. Vous devrez aussi v&eacute;rifier que vos squelettes et fichiers de langue sont compatibles @charset@. D\'autre part le suivi des r&eacute;visions, s\'il est activ&eacute;, sera endommag&eacute;.', # NEW
