...
'avis_connexion_echec_3' => '<b>N.B.</b> Sus ben de serviors, dev&egrave;tz <b>demandar</b> qu\'activen v&ograve;stre acc&egrave;s v&egrave;rs la basa SQL avans de la poer utilizar. Se vos po&egrave;tz pas connectar, verificatz qu\'aiatz ben realizat aquel procediment.', # MODIF
...
'avis_site_syndique_probleme' => 'Atencion: la sindicacion d\'aquel sit a rescontrat un probl&egrave;ma; lo sist&egrave;ma es doncas interromput temporariament. Verificatz l\'adrei&ccedil;a dau fichier de sindicacion d\'aquel sit (<b>@url_syndic@</b>), e tornatz assajar de recuperar las informacions.', # MODIF
...
'info_connexion_ldap_ok' => 'La connexion LDAP a abotit.</b><p> Po&egrave;tz passar a l\'estapa seguenta.', # MODIF
...
'info_sauvegarde_reussi_02' => 'La basa es estaa sauvagardaa dins @archive@. Po&egrave;tz',
...
'text_article_propose_publication' => 'Article prepausat per la publicacion. Esitetz pas de donar v&ograve;stre av&iacute;s gr&agrave;cias au forum estachat a aquel article (en bas de pagina).', # MODIF
...
'texte_connexion_mysql' => 'Consultatz las informacions que v&ograve;stre auberjaor forn&iacute;s: i dev&egrave;tz trobar, se v&ograve;stre auberjaor sup&ograve;rta SQL, los c&ograve;des de connexion au servior SQL.', # MODIF
...
'texte_documents_joints' => 'Po&egrave;tz autorizar que s\'apondan de documents (fichiers burotics, imatges,
 ...
 l\'article, o apar&eacute;isser a despart.<p>', # MODIF
...
'texte_en_cours_validation' => 'Se prepausa de publicar los articles e br&egrave;vas &ccedil;ai sos. Esitetz pas per donar v&ograve;stre av&iacute;s gr&agrave;cias als forums que i son estachats.', # MODIF
...
'texte_nouvelle_version_spip_2' => 'Aquesta version nov&egrave;la demanda una actualizacion mai completa que de costuma. Se siatz webm&egrave;stre/webm&egrave;stra dau sit, volhatz esfa&ccedil;ar lo fichier <tt>inc_connect.php3</tt> dau repert&ograve;ri <tt>ecrire</tt> e tornar prene l\'installacion a fin d\'actualizar v&ograve;stres param&egrave;tres de connexion a la basa de donaas.<p> (NB: s\'av&egrave;tz eissubliat v&ograve;stres param&egrave;tres de connexion, agachatz lo fichier  <tt>inc_connect.php3</tt> avans de lo suprimir...)</p>', # MODIF
...
'texte_utilisation_moteur_syndiques' => 'Quand utilizatz lo cerchaor integrat 
   ...
   Se referenciatz un sit, alora SPIP far&agrave; la
    c&egrave;rcha dins lo t&egrave;xt dau sit mesme.', # MODIF
