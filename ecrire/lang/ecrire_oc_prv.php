...
'avis_connexion_echec_3' => '<b>N.B.</b> Sus f&ograve;r&ccedil;a servidors, dev&egrave;tz <b>demandar</b> qu\'activen v&ograve;stre acc&egrave;s a la basa SQL avans de la poder utilizar. Se vos pod&egrave;tz pas connectar, verificatz qu\'agatz ben realizat aqueu procediment.', # MODIF
...
'avis_site_syndique_probleme' => 'Atencion: la sindicacion d\'aqueu sit a rescontrat un probl&egrave;ma; lo sist&egrave;ma es doncas interromput tempor&agrave;riament. Verificatz l\'adrei&ccedil;a dau fichier de sindicacion d\'aqueu sit (<b>@url_syndic@</b>), e tornatz assajar de recuperar leis informacions.', # MODIF
...
'erreur_plugin_fichier_absent' => 'Fichi&egrave;r absent', # NEW
'erreur_plugin_fichier_def_absent' => 'Fichi&egrave;r de definicion absent', # NEW
'erreur_plugin_nom_fonction_interdit' => 'Nom de foncion enebit', # NEW
'erreur_plugin_nom_manquant' => 'Nom d\'ajuston mancant', # NEW
'erreur_plugin_prefix_manquant' => 'Espaci de nommatge de l\'ajuston non definit', # NEW
'erreur_plugin_tag_plugin_absent' => '&lt;ajuston&gt; mancant dins lo fichi&egrave;r de definicion', # NEW
'erreur_plugin_version_manquant' => 'Version de l\'ajuston mancanta', # NEW
...
'ical_texte_rss' => 'Pod&egrave;tz sindicar lei novetats d\'aquest sit dins quin legidor de fichiers que si&aacute; en format XML/RSS (Rich Site Summary). Es tanben lo format que permet a SPIP de legir lei novetats publicadas dins d\'autrei sits en utilizant un format d\'escambi compatible (sits sindicats). ',
...
'info_config_suivi_explication' => 'Vos pod&egrave;tz abonar a la lista de difusion d\'aquest sit. Alora recebretz per e-mail leis anoncis d\'articles e de br&egrave;vas que se prepausa a la publicacion.',
...
'info_creation_mots_cles' => 'Creatz e configuratz aic&iacute; lei mots clau dau sit',
...
'info_forum_ouvert' => 'Dins l\'espaci privat dau sit, un forum es dob&egrave;rt a totei lei redactors registrats. Pod&egrave;tz, &ccedil;ai sota, activar un forum suplementari, reservat ren qu\'ais administrators.',
'info_forum_statistiques' => 'Estadisticas dei vesitas',
'info_forums_abo_invites' => 'V&ograve;stre sit web porg&iacute;s de forums per leis abonats; dins lo sit public lei vesitaires son convidats a se registrar.',
'info_gauche_admin_effacer' => '<b>A aquela pagina, ren que lei responsables dau sit i p&ograve;don accedir.</b><p> Permet de trobar lei diferentei foncions de mantenen&ccedil;a tecnica. D\'unei que i a implican un proc&egrave;s d\'autentificacion especific, que necessita un acc&egrave;s FTP au sit web.</p>', # MODIF
'info_gauche_admin_tech' => '<b>A aquela pagina, ren que lei responsables dau sit i p&ograve;don accedir.</b><p> Permet de trobar lei diferentei foncions de mantenen&ccedil;a tecnica. D\'unei que i a implican un proc&egrave;s d\'autentificacion especific, que necessita un acc&egrave;s FTP au sit web.</p>', # MODIF
'info_gauche_admin_vider' => '<b>A aquela pagina, ren que lei responsables dau sit i p&ograve;don accedir.</b><p> Permet de trobar lei diferentei foncions de mantenen&ccedil;a tecnica. D\'unei que i a implican un proc&egrave;s d\'autentificacion especific, que necessita un acc&egrave;s FTP au sit web.</p>', # MODIF
'info_gauche_auteurs' => 'Trobaretz aic&iacute; totei leis autors dau sit. La color deis ic&ograve;nas n\'indica l\'estatut (administrator = verd; redactor = jaune).',
...
'info_gauche_messagerie' => 'La messatjari&aacute; vos permet d\'escambiar de messatges entre redactors, de servar de mementos (per v&ograve;stre usatge personau) o d\'afichar d\'anoncis sus la pagina d\'acuelh de l\'espaci privat (se siatz administrator/tritz).',
...
'info_image_process' => 'Vougatz seleccionar lo melhor met&ograve;de de fabricacion dei vinhetas en clicant sus l\'imatge correspondent.',
'info_image_process2' => '<b>N.B.</b> <i>Se ges d\'imatge apareis, aladonc lo servidor qu\'aub&egrave;rga v&ograve;stre sit l\'an pas configurat per utilizar d\'aisinas talas. Se desiratz d\'utilizar aquelei foncions, contactatz lo responsable tecnic e demandatz leis extensions &laquo;GD&raquo; o &laquo;Imagick&raquo;.</i>',
...
'info_mise_a_niveau_base_2' => '{{Atencion!}} Av&egrave;tz installada una version
  ...
  avans sus aquest sit: riscatz de p&egrave;rdre v&ograve;stra basa de donadas
   e v&ograve;stre sit foncionar&agrave; pus.<br />{{Tornatz installar lei
  fichiers d\'SPIP.}}',
...
'info_mots_cles_association' => 'Lei mots clau d\'aqueu grop se p&ograve;don associar:',
'info_moyenne' => 'mejana:',
...
'info_pense_bete_ancien' => 'V&ograve;strei mementos ancians', # MODIF
...
'info_pour' => 'per',
'info_preview_admin' => 'Solament leis administrators p&ograve;don previsualizar lo sit',
'info_preview_comite' => 'Totei lei redactors p&ograve;don previsualizar lo sit',
'info_preview_desactive' => 'La previsualizacion es dau tot desactivada',
'info_preview_texte' => 'Es possible de previsualizar lo sit coma s\'avi&aacute;n publicat totei leis articles e br&egrave;vas (que tenon aumens l\'estatut "prepausat"). La cau dobrir, aquela possibilitat, ren qu\'ais administrators, a totei lei redactors, o en degun?',
...
'info_recherche_auteur_a_affiner' => 'Tr&ograve;p de resultats per "@cherche_auteur@"; vougatz afinar la c&egrave;rca.',
...
'info_syndication_integrale_1' => 'V&ograve;stre sit prepausa de fichi&egrave;rs de sindicacion (v&eacute;ser &laquo;&nbsp;<a href="@url@">@titre@</a>&nbsp;&raquo;).', # NEW
'info_syndication_integrale_2' => 'Desiratz transmetre l\'integralitat dels articles, o ne difusar pas qu\'un resumit de qualques centenas de caract&egrave;rs&nbsp;?', # NEW
...
'info_tout_site3' => 'An revirat l\'article dins aquela lenga, mai an portat puei de modificacions a l\'article de refer&eacute;ncia. Cau actualizar la revirada.',
...
Lei reviradas s\'ass&ograve;cian a l\'originau,
...
'info_urlref' => 'Liame ipert&egrave;xt:',
...
'item_autoriser_syndication_integrale' => 'Difusar l\'integralitat dels articles dins los fichi&egrave;rs de sindicacion', # NEW
...
'item_limiter_recherche' => 'Limitar la c&egrave;rca ais informacions contengudas dins v&ograve;stre sit',
'item_login' => 'Login',
...
'item_non_ajout_mots_cles' => 'Pro&iuml;bir l\'utilizacion dei mots clau dins lei forums',
...
'item_non_autoriser_syndication_integrale' => 'Ne difusar pas qu\'un resumit', # NEW
...
'item_non_utiliser_config_groupe_mots_cles' => 'Pas utilizar la configuracion avan&ccedil;ada dei grops de mots clau',
...
'syndic_choix_resume' => 'D\'unes sits difusan lo t&egrave;xt complet dels articles. Quora aqueste es disponible, desiratz de lo sindicar?&nbsp;:', # NEW
...
'taille_cache_maxi' => 'SPIP assaja de limitar la talha dau repert&ograve;ri <code>CACHE/</code> d\'aqueu sit a <b>@octets@</b> de donadas aperaqu&iacute;.',
...
'text_article_propose_publication' => 'Article prepausat per la publicacion. Esitetz pas de donar v&ograve;stre vejaire gr&agrave;cias au forum estacat a aquel article (en bas de pagina).', # MODIF
...
'texte_acces_ldap_anonyme_1' => 'D\'unei servidors LDAP acc&egrave;ptan ges d\'acc&egrave;s anonim. En aqueu cas, cau especificar un identificant d\'acc&egrave;s iniciau per poder puei cercar d\'informacions dins l\'annuari. Pasmens, lei camps seguents se poir&agrave;n laissar vueges dins la m&agrave;ger part dei cas.',
...
'texte_admin_tech_02' => 'Atencion: aquela sauvagarda se poir&agrave; restaurar REN QUE dins un sit installat amb la meteissa version d\'SPIP. Donc subretot cau pas "vujar la basa" en esperant de re&iuml;nstallar la sauvagarda apr&egrave;s una actualizacion. Consultatz <a href="@spipnet@">la documentacion d\'SPIP</a>.', # MODIF
...
'texte_auteur_messagerie' => 'Aquest sit vos p&ograve;t indicar de contunha la tiera dei redactors connectats, &ccedil;&ograve; que vos permet d\'escambiar de messatges en dir&egrave;cte. Pod&egrave;tz decidir de pas apar&eacute;isser dins aquela lista (siatz "invisible/a" per leis autreis utilizaires).',
...
'texte_connexion_mysql' => 'Consultatz leis informacions que v&ograve;stre aubergador forn&iacute;s: i dev&egrave;tz trobar, se v&ograve;stre aubergador sup&ograve;rta SQL, lei c&ograve;des de connexion au servidor SQL.', # MODIF
...
'texte_documents_joints' => 'Pod&egrave;tz autorizar que s\'apondan de documents (fichiers burotics, imatges,
 ...
 l\'article, o apar&eacute;isser a despart.', # MODIF
...
'texte_en_cours_validation' => 'Se prepausa de publicar leis articles e br&egrave;vas &ccedil;ai sota. Esitetz pas de donar v&ograve;stre vejaire gr&agrave;cias ai forums que i son estacats.', # MODIF
...
'texte_fichier_authent' => '<b>Deu crear, SPIP, de fichiers especiaus  <tt>.htpasswd</tt>
 ...
 Se vos s&egrave;rv pas, pod&egrave;tz laissar aquesta opcion
...
'texte_jeu_caractere_4' => 'En cas qu\'aqu&ograve; corresponda pas a la realitat de v&ograve;stras donadas), o <em>que comencetz a pro pena aquel sit</em> e desiretz causir un autre j&ograve;c de caract&egrave;rs, indicatz-lo aic&iacute;&nbsp;: ', # NEW
'texte_jeu_caractere_conversion' => 'N&ograve;ta&nbsp;: pod&egrave;tz decidir de convertir un c&ograve;p per totes l\'ensem dels t&egrave;xtes de v&ograve;stre sit (articles, br&egrave;vas, forums, etc.) cap a l\'alfabet <tt>utf-8</tt>, en anar a <a href="@url@">la pagina de conversion v&egrave;rs l\'utf-8</a>.', # NEW
...
'texte_mots_cles' => 'Dieumerc&eacute; lei mots clau pod&egrave;tz crear de liames tematics entre v&ograve;streis articles
...
'texte_mots_cles_dans_forum' => 'Desiratz, vos, de permetre l\'utilizacion dei mots clau, seleccionables per lei vesitaires, dins lei forums dau sit public? (Atencion: es pron compl&egrave;xe d\'utilizar aquela opcion correctament.)',
...
'texte_presente_plugin' => 'Aquela pagina lista los ajustons disponibles sus lo sit. Pod&egrave;tz activar los ajustons necessaris en marcar la casa correspondenta.', # NEW
...
'texte_sauvegarde_compressee' => 'La sauvagarda se far&agrave; dins lo fichier non comprimit @fichier@.',
...
'texte_utilisation_moteur_syndiques' => 'Quora utilizatz lo cercador integrat 
    ...
    simple consist&iacute;s a cercar ren que dins lei
    t&iacute;tols e descriptius deis articles. <br /><img src=\'puce.gif\'>
    Lo segond biais, ben mai potent, permet
    a SPIP de cercar tanben dins lo t&egrave;xt dei
    sits referenciats. 
   Se referenciatz un sit, alora SPIP far&agrave; la
    c&egrave;rca dins lo t&egrave;xt dau sit meteis.', # MODIF
...
'utf8_convert_attendez' => 'Esperatz un momenton e tornatz cargar aquesta pagina.', # NEW
'utf8_convert_avertissement' => 'S&egrave;tz a mand de convertir lo  contengut de v&ograve;stra basa de donadas (articles, br&egrave;vas, etc) del j&ograve;c de caract&egrave;rs <b>@orig@</b> cap al j&ograve;c de caract&egrave;rs <b>@charset@</b>.', # NEW
'utf8_convert_backup' => 'Doblid&egrave;tz pas de far d\'en primi&egrave;r un salvament complet de v&ograve;stre sit. Vos cal tanben verificar que v&ograve;stras esqueletas e fichi&egrave;rs de lenga son compatibles @charset@. De mai, lo seguit de las revisions, s\'es activat, ser&agrave; degalhat.', # NEW
'utf8_convert_erreur_deja' => 'V&ograve;tre sit es ja en @charset@, inutil de lo convertir...', # NEW
'utf8_convert_erreur_orig' => 'Error&nbsp;: lo j&ograve;c de caract&egrave;rs @charset@ es pas suportat.', # NEW
'utf8_convert_termine' => 'Es acabat&nbsp;!',
'utf8_convert_timeout' => '<b>Important&nbsp;:</b> en cas de <i>timeout</i> del servidor, volgatz recargar la pagina fins a &ccedil;&ograve; qu\'indique &laquo;&nbsp;acabat&nbsp;&raquo;.', # NEW
'utf8_convert_verifier' => 'Vos cal ara vojar l\'escondedor, e verificar que tot va plansus las paginas publicas del sit. En cas de gr&ograve;s probl&egrave;ma, un salvament de v&ograve;stras donadas s\'es realizat (de format SQL) dins lo repert&ograve;ri @rep@.', # NEW
