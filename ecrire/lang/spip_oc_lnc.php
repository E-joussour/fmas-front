...
'double_occurrence' => 'Dobla ocurr&eacute;ncia', # MODIF
...
'erreur' => 'Error',
'erreur_balise_non_fermee' => 'darri&egrave;ra balisa non tampada :',
...
'form_pet_envoi_mail_confirmation' => 'Ara recebretz un e-mail de confirmacion. Per validar v&ograve;stra signatura, cal vesitar l\'adrei&ccedil;a web men&ccedil;onada per aqueste corri&egrave;r.', # MODIF
...
'numero' => 'Num&egrave;ro',

// O
'occurence' => 'Ocurr&eacute;ncia',
...
'texte_inc_config' => 'Las modificacions fachas dins aquestas paginas influ&eacute;ncian bravament lo
 ...
 acostumat/ada al foncionament del sist&egrave;ma SPIP. <br /><br /><b>
...
'zbug_doublon_table_sans_index' => 'doblons sus una taula sens ind&egrave;x', # MODIF
...
'zbug_pagination_sans_critere' => '#PAGINATION sens crit&egrave;ri {pagination} o emplegat dins una bocla recursiva', # MODIF
...
'zxml_mais_de' => 'mas de',
'zxml_non_conforme' => 'es pas conf&ograve;rm al motiu',
'zxml_non_fils' => 'es pas un filh de',
'zxml_nonvide_balise' => 'balisa non voida',
'zxml_obligatoire_attribut' => 'atribut obligat&ograve;ri mas absent dins',
'zxml_succession_fils_incorrecte' => 'succession dels filhs incorr&egrave;cte',
'zxml_survoler' => 'susvolar per veire los corr&egrave;ctes',
